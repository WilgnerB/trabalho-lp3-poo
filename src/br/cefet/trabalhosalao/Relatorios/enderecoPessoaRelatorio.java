 ...
 * @author wilgn
 */
public class enderecoPessoaRelatorio {
        
    public void emitirRelatorio(List <enderecoPessoa> pList){
        String reportSource = "./reportEnderecoPessoa.jasper";
    ...
    public void processar() throws JRException, ClassNotFoundException, SQLException, DaoException{
        String reportSrcFile = "./reportEnderecoPessoa.jrxml";
