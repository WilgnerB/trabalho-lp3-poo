 ...
 * @author wilgn
 */
public class servicoTipoRelatorio {
        
    public void emitirRelatorio(List <servicoTipo> pList){
        String reportSource = "./reportServicoTipo.jasper";
    ...
    public void processar() throws JRException, ClassNotFoundException, SQLException, DaoException{
        String reportSrcFile = "./reportServicoTipo.jrxml";
