 ...
 * @author nic
 */
public class ViewExclusaoServico extends javax.swing.JDialog {
    ISalao salao;
    Servico s;
    public ViewExclusaoServico(Servico s) {
        salao = Salao.getInstance();
        this.s=s;
        initComponents();
        jLabelServico.setText("Nome:" + s.getNmServico());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deseja Realmente Excluir o Serviço?");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ViewServico frame = null;
        frame = new ViewServico();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            salao.deleteServico(s);
        } catch (DaoException ex) {
            Logger.getLogger(ViewExclusaoServico.class.getName()).log(Level.SEVERE, null, ex);
        }
