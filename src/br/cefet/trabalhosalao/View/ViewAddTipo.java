 ...
 * @author nic
 */
public class ViewAddTipo extends javax.swing.JFrame {
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        try {
            salao.createTipo(1,txtTipo.getText());
            JOptionPane.showMessageDialog(null, "Cadastrado com sucesso!");
        } catch (DaoException ex) {
            Logger.getLogger(ViewAddTipo.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAddTipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAddTipo().setVisible(true);
            }
        });
    }
